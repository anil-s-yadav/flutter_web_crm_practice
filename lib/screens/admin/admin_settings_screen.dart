              ...
              children: [
                ...
                _buildSection(
                  ...
                  children: [
                    ...
                    _buildSwitch(
                      'SMS Alerts',
                      'Instant text messages for urgent issues',
                      _smsAlerts,
                    ...
                    _buildSwitch(
                      ...
                      _paymentReminders,
                      (v) => setState(() => _paymentReminders = v),
                      isDark,
                    ),
                    _buildSwitch(
                      'Contract Expiry',
                      'Alert 30 days before contract ends',
                      _contractExpiry,
                      (v) => setState(() => _contractExpiry = v),
                      isDark,
                    ),
                    _buildSwitch(
                      'SLA Breach',
                      'Alert when SLA timeline is missed',
                      _slaBreach,

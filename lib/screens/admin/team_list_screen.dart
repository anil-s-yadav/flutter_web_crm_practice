...
class _TeamListScreenState extends State<TeamListScreen> {
  ...
  void _initializeDataSource() {
    ...
    if (_teamDataSource == null) {
      ...
      _teamDataSource!.updateData(users);
    }
  }
      ...
      body: Column(
        children: [
          ...
          if (_showFilters && isMobile)
            ...
            _buildMobileToolbar(isDark, allFiltered.length),
            ...
            child: Row(
              ...
              children: [
                Container(
                  ...
                  child: Text(
                    '${allFiltered.length} Members found',
                    style: GoogleFonts.poppins(
                      fontSize: 12,
                      ...
                      child: Row(
                        children: [
                          if (user.role == UserRole.sales) ...[
                            _buildMiniStat(
                              'Clients',
                              user.clientsConverted,
                              isDark,
                            ),
                            const SizedBox(width: 16),
                            _buildMiniStat(
                              'Contracts',
                              user.contractsClosed,
                              isDark,
                            ),
                          ] else if (user.role == UserRole.sourcing) ...[
                            _buildMiniStat(
                              'Added',
                              user.candidatesAdded,
                              isDark,
                            ),
                          ] else ...[
                            Text(

  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Column(
        children: [
          // --- Mobile Toolbar ---
          if (isMobile) _buildMobileToolbar(isDark, filteredLogs.length),
          ...
          Expanded(
            child:
                context.media.width < 800
                    ? _buildMobileListView(filteredLogs, formatter, isDark)
                    : LayoutBuilder(
          ...
          SizedBox(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  log.userRole.name[0].toUpperCase() +
                      log.userRole.name.substring(1),
                  style: GoogleFonts.poppins(
                ...
                Row(
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        Text(
                          'User - ${log.userRole.name[0].toUpperCase() + log.userRole.name.substring(1)}',
                          style: GoogleFonts.poppins(
                            fontSize: 10,
                            color:
                        ...
                        // Text(log.userRole.name[0].toUpperCase() + log.userRole.name.substring(1), style: GoogleFonts.poppins(color: AppColors.grey500, fontSize: 10)),
                      ],
                    ),
                    Column(

...
class TeamDataSource extends DataGridSource {
  ...
  void _buildDataGridRows() {
    _dataGridRows =
        _teamMembers.map<DataGridRow>((user) {
          return DataGridRow(
            cells: [
              ...
              return Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    IconButton(
                      onPressed: () {
                        // TODO: Implement toggleCrmUserStatus using an appropriate bloc
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(
                            content: Text('Status toggle not implemented yet'),
                          ),
                        );
                      },
                      icon: Icon(

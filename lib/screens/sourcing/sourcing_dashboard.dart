...
class _SourcingDashboardState extends State<SourcingDashboard> {
  ...
  late final List<MaidModel> _recentMaids;
  final _indianFormat = NumberFormat('#,##,###', 'en_IN');

  @override
  void initState() {
    super.initState();
    final result = MockDataGenerator.getMaids(
      const PaginationParams(pageSize: 5),
    );
    _recentMaids = result.items;
  }
